<template>
  <div class="graph-panel">
    <div class="panel-header">
      <span class="panel-title">{{ $t('graph.relationshipVisualization') }}</span>
    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? $t('graph.memoryUpdatingRealtime') : $t('graph.updatingRealtime') }}
        </div>
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">{{ $t('graph.simulationFinishedHint') }}</span>
          ...
          <div v-else class="detail-content">
            ...
            <template v-if="selectedItem.data.isSelfLoopGroup">
              <div class="edge-relation-header self-loop-header">
                ...
                <span class="self-loop-count">{{ selectedItem.data.selfLoopCount }} {{ $t('common.items') }}</span>
              </div>
      ...
      <div v-else-if="loading" class="graph-state">
        ...
        <p>{{ $t('graph.loadingGraphData') }}</p>
      </div>

      <!-- Waiting/Empty State -->
      <div v-else class="graph-state">
        <div class="empty-icon">❖</div>
        <p class="empty-text">{{ $t('graph.waitingForOntology') }}</p>
      </div>
    </div>
