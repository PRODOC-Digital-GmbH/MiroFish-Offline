    ...
    <div class="control-bar">
      <div class="status-group">
        ...
        <div class="platform-status twitter" :class="{ active: runStatus.twitter_running, completed: runStatus.twitter_completed }">
          ...
          <div class="actions-tooltip">
            ...
            <div class="tooltip-actions">
              <span class="tooltip-action">{{ $t('step3.actionPost') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionLike') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionRepost') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionQuote') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionFollow') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionIdle') }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="platform-status reddit" :class="{ active: runStatus.reddit_running, completed: runStatus.reddit_completed }">
          ...
          <div class="actions-tooltip">
            ...
            <div class="tooltip-actions">
              <span class="tooltip-action">{{ $t('step3.actionPost') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionComment') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionLike') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionDislike') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionSearch') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionTrend') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionFollow') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionMute') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionRefresh') }}</span>
              <span class="tooltip-action">{{ $t('step3.actionIdle') }}</span>
            </div>
          </div>
        </div>
      ...
      <div class="action-controls">
        ...
        >
          ...
          {{ isGeneratingReport ? $t('step3.starting') : $t('step3.startGeneratingReport') }}
              ...
              <div class="card-body">
                ...
                <template v-if="action.action_type === 'REPOST'">
                  <div class="repost-info">
                    ...
                    <span class="repost-label">{{ $t('step3.repostedFrom', { user: action.action_args?.original_author_name || 'User' }) }}</span>
                  </div>
                ...
                <template v-if="action.action_type === 'LIKE_POST'">
                  <div class="like-info">
                    ...
                    <span class="like-label">{{ $t('step3.likedPost', { user: action.action_args?.post_author_name || 'User' }) }}</span>
                  </div>
                ...
                <template v-if="action.action_type === 'FOLLOW'">
                  <div class="follow-info">
                    ...
                    <span class="follow-label">{{ $t('step3.followedUser', { user: action.action_args?.target_user || action.action_args?.user_id || 'User' }) }}</span>
                  </div>
                </template>
...
const doStartSimulation = async () => {
  ...
  try {
    ...
    addLog(t('step3.dynamicGraphUpdateEnabled'))
...
const getActionTypeLabel = (type) => {
  const labels = {
    'CREATE_POST': t('step3.actionPost'),
    'REPOST': t('step3.actionRepost'),
    'LIKE_POST': t('step3.actionLike'),
    'CREATE_COMMENT': t('step3.actionComment'),
    'LIKE_COMMENT': t('step3.actionLike'),
    'DO_NOTHING': t('step3.actionIdle'),
    'FOLLOW': t('step3.actionFollow'),
    'SEARCH_POSTS': t('step3.actionSearch'),
    'QUOTE_POST': t('step3.actionQuote'),
    'UPVOTE_POST': t('step3.actionUpvote'),
    'DOWNVOTE_POST': t('step3.actionDownvote')
  }
  return labels[type] || type || t('step3.actionUnknown')
}
