      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            ...
            <span>{{ ontologyProgress.message || $t('step1.analyzingDocuments') }}</span>
          </div>
...
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      alert(t('step1.failedToCreateSimulation') + ' ' + (res.error || ''))
    }
  } catch (err) {
    console.error('Simulation creation exception:', err)
    alert(t('step1.failedToCreateSimulation') + ' ' + err.message)
  } finally {
