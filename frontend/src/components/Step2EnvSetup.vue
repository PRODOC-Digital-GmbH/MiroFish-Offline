      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.simulationInstanceInit') }}</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 0" class="badge success">{{ $t('common.completed') }}</span>
            <span v-else class="badge processing">{{ $t('step2.initialization') }}</span>
          </div>
        </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.generateAgentPersonas') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">{{ $t('step2.currentRelatedTopicsCount') }}</span>
            </div>
          </div>
            ...
            <div class="profiles-list">
              ...
              >
                <div class="profile-header">
                  <span class="profile-realname">{{ profile.username || $t('step2.unknownAgent') }}</span>
                  <span class="profile-username">@{{ profile.name || `agent_${idx}` }}</span>
                </div>
                <div class="profile-meta">
                  <span class="profile-profession">{{ profile.profession || $t('step2.unknownProfession') }}</span>
                </div>
                <p class="profile-bio">{{ profile.bio || $t('step2.noIntroduction') }}</p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.generateDualPlatformConfig') }}</span>
          </div>
          <div class="step-status">
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">{{ $t('step2.durationPerRound') }}</span>
              ...
              <div class="time-periods">
                ...
                <div class="period-item">
                  <span class="period-label">{{ $t('step2.workingHours') }}</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.work_hours?.[0] }}:00-{{ simulationConfig.time_config?.work_hours?.slice(-1)[0] }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.work_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">{{ $t('step2.morningTimePeriod') }}</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.morning_hours?.[0] }}:00-{{ simulationConfig.time_config?.morning_hours?.slice(-1)[0] }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.morning_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">{{ $t('step2.valleyPeriod') }}</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ $t('step2.agentConfiguration') }}</span>
              ...
              <div class="agents-cards">
                ...
                >
                  ...
                  <div class="agent-timeline">
                    <span class="timeline-label">{{ $t('step2.activePeriod') }}</span>
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">{{ $t('step2.postsPerTime') }}</span>
                        <span class="param-value">{{ agent.posts_per_hour }}</span>
                      </div>
                      <div class="param-item">
                        <span class="param-label">{{ $t('step2.commentsPerTime') }}</span>
                    ...
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        <span class="param-label">{{ $t('step2.sentimentTendency') }}</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ $t('step2.recommendationAlgorithmConfig') }}</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  ...
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">{{ $t('step2.timeWeight') }}</span>
                    ...
                    <div class="param-row">
                      <span class="param-label">{{ $t('step2.virusThreshold') }}</span>
            ...
            <div v-if="simulationConfig.generation_reasoning" class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ $t('step2.llmConfigInference') }}</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.initialActivationArrangement') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="topics-section">
              <span class="box-label">{{ $t('step2.initialTrendingTopics') }}</span>
            ...
            <div class="initial-posts-section">
              <span class="box-label">{{ $t('step2.initialActivationSequence', { count: simulationConfig.event_config.initial_posts.length }) }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.preparationCompleted') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ $t('step2.preparationCompletedDesc') }}</p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">{{ $t('step2.simulationRoundsSetting') }}</span>
                <span class="section-desc" v-html="$t('step2.roundsAutoDesc', { hours: simulationConfig?.time_config?.total_simulation_hours || '-', minutes: simulationConfig?.time_config?.minutes_per_round || '-' })"></span>
              </div>
          ...
          <div class="action-group dual">
            <button 
              ...
              @click="$emit('go-back')"
            >
              ← {{ $t('step2.returnGraphConstruction') }}
            </button>
            <button
            ...
            >
              {{ $t('step2.startDualWorldSimulation') }} ➝
            </button>
          </div>
        </div>
      </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">{{ $t('step2.ageLabel') }}</span>
              <span class="info-value">{{ selectedProfile.age || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ $t('step2.genderLabel') }}</span>
            ...
            <div class="info-item">
              <span class="info-label">{{ $t('step2.mbtiLabel') }}</span>
          ...
          <div class="modal-section">
            <span class="section-label">{{ $t('step2.personaIntroduction') }}</span>
            <p class="section-bio">{{ selectedProfile.bio || $t('step2.noIntroduction') }}</p>
          </div>

          <!-- Followed Topics -->
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">{{ $t('step2.realitySeedRelatedTopics') }}</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">{{ $t('step2.detailedPersonaBackground') }}</span>
            
            <!-- Persona Dimension Overview -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">{{ $t('step2.eventPanoramicExperience') }}</span>
                <span class="dim-desc">{{ $t('step2.eventPanoramicDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ $t('step2.behaviorPatternProfiling') }}</span>
                <span class="dim-desc">{{ $t('step2.behaviorPatternDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ $t('step2.uniqueMemoryImprints') }}</span>
                <span class="dim-desc">{{ $t('step2.uniqueMemoryDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ $t('step2.socialRelationshipNetwork') }}</span>
                <span class="dim-desc">{{ $t('step2.socialRelationshipDesc') }}</span>
              </div>
            </div>
